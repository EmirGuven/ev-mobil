...
const { data: page } = await useFetch<LegalPage>('/api/legal/gizlilik')

usePageSeo({
  title: page.value?.title || 'Gizlilik Politikası',
  description: 'Web sitemizde kişisel verilerin nasıl işlendiğine dair gizlilik politikamız.',
  path: '/gizlilik'
})
