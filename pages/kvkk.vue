...
const { data: page } = await useFetch<LegalPage>('/api/legal/kvkk')

usePageSeo({
  title: page.value?.title || 'KVKK Aydınlatma Metni',
  description: 'KVKK kapsamında kişisel verilerinizin nasıl işlendiğine ilişkin aydınlatma metni.',
  path: '/kvkk'
})
